import{C as V}from"./ChangeHistory-BZxVEAah.js";import{C as t}from"./config-CTdRYYkh.js";import"./utils-BD5XdJRN.js";import"./runtime-zEBa7sgE.js";import"./render-BiP2vxfj.js";import"./if-CfGiC-YB.js";import"./branches-xTPa7yEe.js";import"./each-CfxlAklW.js";import"./attributes-CITH35_k.js";import"./style-BOp-ASFv.js";import"./class-Bpq8mdK_.js";import"./lifecycle-_ELeHhwg.js";import"./props-rI6kvREJ.js";const $={title:"CommonComponents/ChangeHistory",component:V,tags:["autodocs"],argTypes:{historyItems:{control:"object",description:"表示する更新履歴の配列"},height:{control:"text",description:'コンポーネントの高さ。CSSの値を指定します (例: "400px")。'},defaultColor:{control:{type:"select"},options:Object.values(t),description:"アイテムに色が指定されていない場合のデフォルトカラー。`CCLVividColor`の値を指定します。"}}},n=[{date:"2025/07/20",title:"メジャーアップデートと新機能の追加",color:t.STRAWBERRY_PINK,tag:"機能追加",version:"v2.0.0",details:["ccl-component-kit4svelteをv2.0.0に更新しました。","新コンポーネント「Dashboard」を追加しました。","パフォーマンスを改善し、ページの読み込み速度が向上しました。"]},{date:"2025/07/01",title:"CROSSをリリースしました",tag:"活動記録",color:t.MELON_GREEN},{date:"2025/05/15",title:"技術書典18にサークル参加しました",tag:"イベント"},{date:"2025/04/10",title:"軽微なバグ修正",version:"v1.5.2"}],Y=[...n,{date:"2025/03/15",title:"UIコンポーネントのドキュメントを更新",tag:"ドキュメント",color:t.GRAPE_PURPLE},{date:"2025/02/01",title:"パフォーマンスチューニングを実施",version:"v1.5.1"},{date:"2025/01/20",title:"Selectコンポーネントの不具合を修正",tag:"バグ修正",color:t.PINEAPPLE_YELLOW,version:"v1.5.0"},{date:"2025/01/05",title:"Checkboxコンポーネントを追加",tag:"機能追加",color:t.STRAWBERRY_PINK}],e={name:"Default",args:{historyItems:n,defaultColor:t.SODA_BLUE}},o={name:"Custom Default Color",args:{historyItems:n,defaultColor:t.PINEAPPLE_YELLOW}},r={name:"Single Item",args:{historyItems:[n[0]]}},s={name:"Empty",args:{historyItems:[]}},a={name:"Minimal",args:{historyItems:[{date:"2025/01/01",title:"プロジェクトを開始しました。"},{date:"2024/12/25",title:"プレリリース版を公開しました。"}]}},i={name:"With Limited Height",args:{historyItems:Y,height:"400px",defaultColor:t.SODA_BLUE}};var m,c,l,d,p;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: 'Default',
  args: {
...
//# sourceMappingURL=ChangeHistory.stories-C01tX13v.js.map
